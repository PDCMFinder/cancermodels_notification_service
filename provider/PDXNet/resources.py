file_paths = {
    ...
    'PDMR_mol': 'input/PDXNet/PDXNet_PDMR_mol_meta.csv',
    'PDTC_mol': 'input/PDXNet/PDXNet_PDTC_mol_meta.csv',
    'source': '/Users/tushar/CancerModels/pdxfinder-data/data/UPDOG/'
}